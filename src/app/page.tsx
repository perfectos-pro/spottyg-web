...
export default function Home() {
  const [messages, setMessages] = useState([{ role: 'system', content: 'Welcome to SpottyG – your music historian assistant!' }])
  ...
  const sendMessage = async () => {
    ...
    const updated = [...messages, { role: 'user', content: input, timestamp }]
    setMessages(updated)
    setInput('')
    ...
    setMessages([...updated, { role: 'assistant', content: data.reply, timestamp: new Date().toISOString() }])
  }
